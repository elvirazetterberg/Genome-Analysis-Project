...
fasta="/home/elze3417/genome_analysis/results/canu_pilon/pilon.fasta"

blastn -db $db -query $fasta -out /home/elze3417/genome_analysis/results/blast/results.blastn -outfmt 6
